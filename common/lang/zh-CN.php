...
$lang->about_layout = '布局是布置模块的外观，在上端布局菜单里单可以进行管理';
$lang->msg_call_server = '系统正在连接服务器，请稍后…';
$lang->msg_db_not_setted = '尚未设定数据';
$lang->msg_dbconnect_failed = '连接数据时发生错误。请重新确认数据信息。';
$lang->msg_invalid_queryid = '数据库指令ID值指定错误';
$lang->msg_failed_to_load_query = '%s 数据指令没有正确执行.';
$lang->msg_not_permitted = '暂无权限';
$lang->msg_input_password = '请输入密码';
$lang->msg_invalid_document = '文章编号错误';
$lang->msg_invalid_request = '请求错误';
